...
ggsave("./Econometria II Maestría Eco/R/2021-II/Tema 4/map_rap.png",
...
tmap_mode("plot")
tmap_save(filename = "./Econometria II Maestría Eco/R/2021-II/Tema 4/mymap.png",
          units = "cm", dpi = 300)
...
scatt_imoran
ggsave("./Econometria II Maestría Eco/R/2021-II/Tema 4/scatt_imoran.png", 
...
scatt_imoran2
ggsave("./Econometria II Maestría Eco/R/2021-II/Tema 4/scatt_imoran2.png", 
...
tmap_save(tm = mur_maps, 
          filename = "./Econometria II Maestría Eco/R/2021-II/Tema 4/mur_map.png",
          height = 10)
...
ggplot() + geom_sf(data=us_merge, aes(fill = cluster), color=NA) +
  ...
  theme(panel.background = element_rect(fill = "white"), #fondo del gráfico
        legend.position = c(0.22, 0.2), #ubicacion de leyenda, dentro del gráfico
        ...
        legend.title=element_text(size=5), #tamaño título leyenda
...
# el modelo Durbin espacial deberá ser estimado
...
# LM1: Ho: Var_effijos=0: no efectos aleatorios asumiendo no correlación espacial
# LM2: Ho: rho=0: no correlación espacial asumiendo no efectos aleatorios
# SLM1: versión estandarizada de LM1
# SLM2: versión estandarizada de LM2
# LMH: Ho: rho=Var_effijos=0: no existen efectos espaciales ni efectos aleatorios
# CLMlambda: Ho: rho=0: no correlación espacial asumiendo la posible existencia
# de efectos aleatorios (Var_effijos puede o no puede ser cero)
# CLMmu: Ho: Var_effijos=0: no efectos aleatorios asumiendo la posibilidad de correlación espacial
