...
Link slides en formato [html](https://gusgarciacruz.github.io/EconometriaAvanzada/ExogeneidadSecuencial/ExogeneidadSecuencial.html)

Link slides en formato [PDF](https://gusgarciacruz.github.io/EconometriaAvanzada/ExogeneidadSecuencial/ExogeneidadSecuencial.pdf)
...
No obstante, existen muchos modelos, incluyendo el modelo AR(1), para lo cual es razonable asumir que $u_{it}$ esta correlacionado con actuales y pasados valores de $\textbf{x}_{it}$
...
- [Código en R](https://gusgarciacruz.github.io/EconometriaAvanzada/ExogeneidadSecuencial/L3.R)